 ...
 */
public abstract class Hilt_DeleteAllCompletedTasksDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeleteAllCompletedTasksDialogFragment() {
    super();
  }

  Hilt_DeleteAllCompletedTasksDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeleteAllCompletedTasksDialogFragment_GeneratedInjector) this.generatedComponent()).injectDeleteAllCompletedTasksDialogFragment(UnsafeCasts.<DeleteAllCompletedTasksDialogFragment>unsafeCast(this));
    }
  }
