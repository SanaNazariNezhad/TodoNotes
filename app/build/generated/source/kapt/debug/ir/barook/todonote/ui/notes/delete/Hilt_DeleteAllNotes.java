 ...
 */
public abstract class Hilt_DeleteAllNotes extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeleteAllNotes(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeleteAllNotes_GeneratedInjector) this.generatedComponent()).injectDeleteAllNotes(UnsafeCasts.<DeleteAllNotes>unsafeCast(this));
    }
  }
